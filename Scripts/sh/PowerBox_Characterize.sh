...
DAEMON=$DIR/PowerBox_Characterize.py
DAEMON_NAME=PowerBox_Characterize

# arguments
DAEMON_OPTS="--service --log /var/log/PowerBox_Characterize.log --beginPower 0 --endPower 5 --nfreq 2500"
