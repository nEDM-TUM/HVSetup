...
DAEMON=$DIR/RecordWaveformBIN.py
DAEMON_NAME=RecordWaveformBIN

# arguments
DAEMON_OPTS="--service --log /var/log/RecordWaveformBIN.log --compress --precision 4 --start 0 --ndata 100000 --scale 1.0"
