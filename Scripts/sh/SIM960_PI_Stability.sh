...
DAEMON=$DIR/SIM960_PI_Stability.py
DAEMON_NAME=SIM960_PI_Stability

# arguments
# --service Makes sure we don't get stuck with e.g. stdin
# --log LOGPATH
# --acquire OSCI_ACQUIRE_MODE
# --samples ACQUIRE_SAMPLES
# --pattern FILENAME_PATTERN
DAEMON_OPTS="--service --log /var/log/SIM960_PI_Stability.log --PROP -19.0 --INTG 2000.0 --LLIM -5.0 --ULIM 5.0"
