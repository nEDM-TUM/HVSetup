...
### BEGIN INIT INFO
# Provides:				PowerBox_Characterize
...
DAEMON=$DIR/Lab_ReadContinuous.py
DAEMON_NAME=Lab_ReadContinuous
...
DAEMON_OPTS="--service --log /var/log/Lab_ReadContinuous.log --acquire SAMPLE --samples 2"
